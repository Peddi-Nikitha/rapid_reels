...
/// Domain model for booking/event data
class BookingModel {
  ...
  factory BookingModel.fromMap(Map<String, dynamic> data, String id) {
    return BookingModel(
      ...
      eventDate: data['eventDate'] is String
  ...
  bool get isPast => eventDate.isBefore(DateTime.now()) || status == 'completed';
  bool get isActive => status == 'ongoing' || status == 'confirmed';
}
